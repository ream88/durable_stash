alias DurableStash.TestApp.Backend
alias DurableStash.TestApp.Endpoint
alias DurableStash.TestApp.PubSub
...
Application.put_env(:durable_stash, Endpoint,
  url: [host: "localhost"],
...
test_app_children = [
  ...
  {DurableStash.TestBackend, name: Backend},
  {DurableServer.Supervisor,
   name: DurableStash.TestApp.StashSupervisor, prefix: "test_app/", backend: {DurableStash.TestBackend, name: Backend}},
  Endpoint
]
